                ...
                */
                ...
                FlexGridFilter.prototype._asODataValueFilter = function (vf) {
                    ...
                    for (var key in vf.showValues) {
                        ...
                        if (val)
                            val += ' or ';
                        val += '(' + fld + ' eq ' + this._asODataValue(value) + ')';
                    }
                    return '(' + val + ')';
                };
                ...
                FlexGridFilter.prototype._asODataCondition = function (cf, cond) {
                    var fld = cf.column.binding, val = this._asODataValue(cond.value);
                ...
                FlexGridFilter.prototype._asODataValue = function (val) {
                    ...
                    */
                    get: function () {
                        switch (this._op) {
                            ...
                            case 8 /* CT */:
                            case 9 /* NC */:
                                return this._strVal != null && this._strVal.length > 0;
                        }
                        return true;
                    },
                    enumerable: true,
