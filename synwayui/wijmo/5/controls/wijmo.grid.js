                ...
                for (var i = 0; i < lines.length && row < this.rows.length; i++, row++) {
                    ...
                    for (var j = 0; j < cells.length && col < this.columns.length; j++, col++) {
                        ...
                        if (!this.columns[col].isReadOnly && !this.rows[row].isReadOnly) {
                            ...
                            e = new grid.CellRangeEventArgs(this.cells, new grid.CellRange(row, col));
        ...
        var CellFactory = (function () {
            ...
            */
            CellFactory.prototype.updateCell = function (panel, r, c, cell, rng, updateContent) {
                var g = panel.grid, ct = panel.cellType, rows = panel.rows, cols = panel.columns, row = rows[r], col = cols[c], r2 = r, c2 = c, gr = wijmo.tryCast(row, _grid.GroupRow), nr = wijmo.tryCast(row, _grid._NewRowTemplate), cellWidth = col.renderWidth, cellHeight = row.renderHeight, cl = 'wj-cell', css = { display: '' }, canSkip = (updateContent != false);
                ...
                if (rng && !rng.isSingleCell) {
                    ...
                    row = rows[r];
                    col = cols[c];
                    gr = wijmo.tryCast(row, _grid.GroupRow);
                                ...
                                setTimeout(function () {
                                    ...
                                    if (edt) {
                                        if (edt.type == 'checkbox') {
                                            ...
                                            wijmo.setSelectionRange(edt, len, len);
                                        }
                                    }
                                });
                            }
                        ...
                        if (!g.columns[g.editRange.col].mask) {
                            setTimeout(function () {
                                ...
                                if (edt && edt.type != 'checkbox') {
                                    ...
                                    wijmo.setSelectionRange(edt, 1, 1);
        ...
        var _MouseHandler = (function () {
            ...
            */
            ...
            _MouseHandler.prototype._mouseDown = function (e) {
                ...
                if (e.target != document.activeElement && !g.containsFocus()) {
                    ...
                    if (ht.panel == g.cells && cell instanceof HTMLElement) {
                        ...
                        ht.panel.hostElement.parentElement.focus();
                    } else {
                        g.focus();
                    }
                }
            ...
            _MouseHandler.prototype._mouseUp = function (e) {
                ...
                if (htd && htd.cellType == 4 /* TopLeft */ && htd.row == 0 && htd.col == 0 && !this._szArgs) {
