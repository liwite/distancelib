...
module wijmo.input {
    ...
    export class InputNumber extends Control {
        ...
        private _setText(text: string) {
            ...
            if (text == '-' || text == ')') {
                this._tbx.value = text;
                setSelectionRange(this._tbx, 1, 1);
                return;
            }
            ...
            if (e.charCode) {
                ...
                if (chr == this._decChar) {
                    ...
                    if (pos > -1) {
                        ...
                        setSelectionRange(this._tbx, pos, pos);
                        e.preventDefault();
                    }
                }
            }
                ...
                case Key.Back:
                    if (this._getSelStart() == this._tbx.selectionEnd) {
                        ...
                        if (sel > 0 && this.text[sel - 1] == this._decChar) {
                            setSelectionRange(this._tbx, sel - 1, sel - 1);
                            e.preventDefault();
                        }
                    }
                    break;
