...
module wijmo {
     ...
     */
    export function setSelectionRange(e: HTMLInputElement, start: number, end: number) {
    ...
    export class Globalize {
        ...
        static parseFloat(value: string, format?: string): number {
            var dp = wijmo.culture.Globalize.numberFormat['.'],
                ...
                neg = value.indexOf('-') > -1 || (value.indexOf('(') > -1 && value.indexOf(')') > -1) ? -1 : +1,
...
module wijmo {
    ...
    export class _MaskProvider {
        ...
        _hKeyPress(e: KeyboardEvent) {
            if (e.charCode && this._mskArr.length) {
                ...
                if (start < this._firstPos) {
                    ...
                    setSelectionRange(el, start, start);
                }
        ...
        _validatePosition(start: number) {
            ...
            setSelectionRange(this.input, start, start);
        }
