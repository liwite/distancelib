...
declare module wijmo.chart {
    ...
    * or follow the mouse or touch position (interaction = Move).
    * For example:
    * <pre>
    ...
    */
    class LineMarker {
        ...
        */
        ...
        /**
        * Gets the @see:FlexChart object that owns this LineMarker.
        */
        public chart : FlexChart;
        /**
        ...
        * This only takes effect when the @see:interaction property is set to wijmo.chart.LineMarkerInteraction.Move.
        */
        ...
        * the horizontal position of the marker is calculated automatically based on the pointer's position.
        */
        ...
        * Its value range is (0, 1).
        * If the value is null or undefined and @see:interaction is set to wijmo.chart.LineMarkerInteraction.Move,
        * the vertical position of the LineMarker is calculated automatically based on the pointer's position.
        */
